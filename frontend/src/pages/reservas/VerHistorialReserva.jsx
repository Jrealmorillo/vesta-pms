              ...
              <div className="d-flex justify-content-between align-items-center flex-wrap">
                <div>
                  <h1 className="h3 mb-2 text-dark">
                    Historial de la Reserva #{id}
                  </h1>
                  <p className="text-muted mb-0">
                    Registro completo de acciones y modificaciones
                  </p>
                </div>
                <div>
                  <span
          ...
          <div className="card border-0 shadow-sm">
            ...
            {historial.length === 0 ? (
              <div className="card-body p-5 text-center">
                ...
                <p className="text-muted mb-0">
                  No hay acciones registradas para esta reserva.
                </p>
              </div>
            ) : (
                      ...
                      <tr key={registro.id_historial} className="align-middle">
                        <td>
                          <div className="fw-medium">
                            {new Date(registro.fecha_accion).toLocaleDateString(
                              "es-ES",
                              {
                                day: "2-digit",
                                month: "2-digit",
                          ...
                          <small className="text-muted">
                            {new Date(registro.fecha_accion).toLocaleTimeString(
                              "es-ES",
                              {
                                hour: "2-digit",
                                minute: "2-digit",
                        ...
                        <td>
                          {registro.detalles ? (
                            <div className="small">{registro.detalles}</div>
                          ) : (
